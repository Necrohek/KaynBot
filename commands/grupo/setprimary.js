    ...
    try {
     ...
     const who = await resolveLidToRealJid(who2, client, m.chat);
      ...
      if (!allowedBots.includes(who)) {
        return client.reply(m.chat, `✖️ El usuario mencionado no es una instancia de Sub-Bot.`, m)
      }

      if (!groupParticipants.includes(who)) {
        return client.reply(m.chat, `✖️ El bot mencionado no está presente en este grupo.`, m)
      }
