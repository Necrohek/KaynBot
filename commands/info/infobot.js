...
export default {
  ...
  run: async (client, m) => {
    ...
    try {
    const message = `ㅤㅤㅤ ㅤ ㅤַָּ֢ٜㅤㅤ    ㅤㅤּ⬪⬧⬪ּㅤㅤ    ㅤㅤַָּ֢ٜㅤㅤㅤ
ㅤ🇪🇪ㅤㅤ 𝖨𝗇𝖿𝗈𝗋𝗆𝖺𝖼𝗂𝗈́𝗇 :: *${botname2}*

✦֗ㅤ Nombre largo: *${botname}*
✦֗ㅤ Nombre corto: *${botname2}*
✦֗ㅤ Prefijos: *${prefijo}*
✦֗ㅤ Cmd Ejec: *${comando.toLocaleString()}*

ㅤ ㅤּٜٜ۬ׄ͜ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ ㅤㅤㅤㅤㅤㅤㅤㅤㅤּٜٜ۬ׄ͜

ㅤּㅤخبׅ𝓲ㅤׂㅤ Tipo: *${botType}*
ㅤּㅤخبׅ𝓲ㅤׂㅤ Developer: ${owner ? (!isNaN(owner.replace(/@s\.whatsapp\.net$/, '')) ? `@${owner.split('@')[0]}` : owner) : "Oculto por privacidad"}
ㅤּㅤخبׅ𝓲ㅤׂㅤ Activo desde: *${formattedUptimeDate}*
ㅤּㅤخبׅ𝓲ㅤׂㅤ Plataforma: *${platform}*
ㅤּㅤخبׅ𝓲ㅤׂㅤ NodeJS: *${nodeVersion}*
    ...
    /*await client.sendMessage(m.chat, {
      ...
      contextInfo: {
        ...
        externalAdReply: {
          ...
          title: botname,
          body: `${botname2}, Built With 🇪🇪 By Kayn Necrohëk`,
          mediaType: 1,
          thumbnailUrl: banner,
         // thumbnail: banner,
         // sourceUrl: redes
