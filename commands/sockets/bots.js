...
export default {
  ...
  run: async (client, m) => {
    ...
    let message = `𒇺፞ㅤㅤ𐄁 Números de Sockets activos *(${totalBots})*\n\n`
    message += `♱𝆬ㅤ˚Principales › *${totalCounts.Owner}*\n`
  //  message += `♱𝆬ㅤPremiums › *${totalCounts.Premium}*\n`
    message += `♱𝆬ㅤSubs › *${totalCounts.Sub}*\n\n`
    message += `𝓲ㅤׂ *Bots en el grupo ›* ${totalInGroup}\n`
